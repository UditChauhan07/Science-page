...
const ScienceSlider2 = () => {
    ...
    const handleShow = (imageSrc2, title2, subTitle2) => {
                            ...
                            <div className={styles.slider2Details}>
                                ...
                                <div className={styles.sliderContent3}>
                                    ...
                                    <div className={styles.btnDivBuy}>
                                        <div className={styles.roundBtn}><p onClick={() => handleShow('/images/modalImgBrunoMd (1).webp', 'Royal Collagen Peptides', 'The Science of Beauty')}>Buy Now</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={styles.slider3data}>
                            ...
                            <div className={styles.slider2Details}>
                                ...
                                <div className={styles.sliderContent3}>
                                    ...
                                    <hr className={styles.blackHr2} />
                                    <div className={styles.btnDivBuy}>
                                        <div className={styles.roundBtn} ><p onClick={() => handleShow('/images/modalImgBrunoMd2.webp', 'CholestQ10 60 v-caps', 'The Science of Heart Health')}>Buy Now</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={styles.slider3data}>
                            ...
                            <div className={styles.slider2Details}>
                                ...
                                <div className={styles.sliderContent3}>
                                    ...
                                    <hr className={styles.blackHr2} />
                                    <div className={styles.btnDivBuy}>
                                        <div className={styles.roundBtn}><p onClick={() => handleShow('/images/modalImgBrunoMd3.webp', 'Riboflam 90 v-caps', 'The Science of Longevity')}>Buy Now</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={styles.slider3data}>
                            ...
                            <div className={styles.slider2Details}>
                                ...
                                <div className={styles.sliderContent3}>
                                    ...
                                    <hr className={styles.blackHr2} />
                                    <div className={styles.btnDivBuy}>
                                        <div className={styles.roundBtn}><p onClick={() => handleShow('/images/modalImgBrunoMd4.webp', 'Bluerex Vision 60 softgels', 'The Science of Sight')}>Buy Now</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
