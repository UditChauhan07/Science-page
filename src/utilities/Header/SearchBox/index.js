...
const SearchBox = () => {
    ...
    const toggle = () => {
        if(document.getElementById("hubspot-messages-iframe-container") && !show) document.getElementById("hubspot-messages-iframe-container").style.top = "3000px";
        if(document.getElementById("hubspot-messages-iframe-container")&& show) document.getElementById("hubspot-messages-iframe-container").style.top = "unset";
        setShow(!show)
        ...
        <>
            {show ?
                <div className={styles.searchBoxContainer}>
                    ...
                    <div className={styles.resultHolder} id='searchResultList'>
