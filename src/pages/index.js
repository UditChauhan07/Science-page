...
export default function Home({version,script = true}) {

  return (
    <>
      <section>
        {SEO[version] && <PageHead content={SEO[version]?.home?.SEO}/>}
        {HomePageData[version] &&<WistiaHero id={HomePageData[version].wistia.id} content={HomePageData[version].wistia.content} video={HomePageData[version].video}/>}
        ...
        {script &&<>
        {HomePageData[version]?.homeGallery &&<HomeGallery id={HomePageData[version].homeGallery.id} galleryId={HomePageData[version].homeGallery.galleryId} content={{title:HomePageData[version].homeGallery.title, desc:HomePageData[version].homeGallery.subTitle, invert:HomePageData[version].homeGallery.invert}} isreviews={true}/>}
