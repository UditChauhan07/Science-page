...
const Riboflam = ({ version }) => {
  ...
  const pageData = landingData['riboflam'] || {}
  ...
  return (
    ...
    <>
      ...
      {pageData?.wistiaVideoId &&<WistiaHero id={pageData.wistiaVideoId} content={{ buyNow: true, ModalHandler }} theme={pageData.announcement.theme} video={pageData.video} />}
      ...
      {pageData?.ReasonsToBelieve &&<ReasonsToBelieve ingredients={pageData.ReasonsToBelieve.ingredients} content={pageData.ReasonsToBelieve.items} theme={pageData.theme} product={pageData.product} />}
...
Riboflam.hideLayout = true;
export default Riboflam;