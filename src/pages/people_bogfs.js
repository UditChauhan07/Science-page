...
const PeopleBogfs = ({ version }) => {
  ...
  const pageData = landingData['people_bogfs'] || {}
  ...
  return (
    ...
    <>
      ...
      {pageData?.ReasonsToBelieve &&<ReasonsToBelieve ingredients={pageData.ReasonsToBelieve.ingredients} content={pageData.ReasonsToBelieve.items} accordanTitle={pageData.ReasonsToBelieve.accordanTitle} theme={pageData.theme} product={pageData.product} />}
...
PeopleBogfs.hideLayout = true;
export default PeopleBogfs;