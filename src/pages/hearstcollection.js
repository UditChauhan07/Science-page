...
const HearstCollection = ({ version }) => {
  ...
  const pageData = landingData['hearstcollection'] || {}
  ...
  return (
    ...
    <>
      ...
      {pageData?.wistiaVideoId &&<WistiaHero id={pageData.wistiaVideoId} content={{ buyNow: true, ModalHandler }} theme={pageData.announcement.theme} height={625} video={pageData.video}/>}
...
HearstCollection.hideLayout = true;
export default HearstCollection;