...
const Bluerex = ({ version }) => {
  ...
  const pageData = landingData['bluerex'] || {}
  ...
  return (
    ...
    <>
      ...
      {pageData?.wistiaVideoId &&<WistiaHero id={pageData.wistiaVideoId} content={{ buyNow: false, ModalHandler }} theme={pageData.announcement.theme} height={725} video={pageData.video} />}
