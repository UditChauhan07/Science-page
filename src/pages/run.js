...
import Try from "@/utilities/Testimonial/index1";
...
const Run = ({ version }) => {
  ...
  return (
    <>
      ...
      {pageData?.wistiaVideoId &&<WistiaHero id={pageData.wistiaVideoId} content={{ buyNow: true, ModalHandler }} video={pageData.video} theme={pageData.announcement.theme}/>}
      ...
      {!pageData?.chat&&<Chat />}
      {pageData?.footer && <div style={{marginBottom:'50px'}}><Footer data={pageData.footer} /></div>}
