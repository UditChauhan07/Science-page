...
const RoyalCollagenPeptides = ({ version }) => {
  ...
  const pageData = landingData['royal-collagen-peptides'] || {}
  ...
  return (
    ...
    <>
      ...
      <MasterHeadImg data={{
            "desktopImage": {
                "src": "/landing/rcpMast.avif",
                "alt": ""
            },
            "mobileImage": {
                "src": "/src/frequenti-mob.webp",
                "alt": ""
            },
            "title": "Bruno MD"
        }} />
      {pageData?.nav &&<StickyNav theme={pageData.announcement.theme}/>}
      {/* {pageData?.wistiaVideoId &&<WistiaHero id={pageData.wistiaVideoId} content={{ buyNow: true, ModalHandler }} theme={pageData.announcement.theme}/>} */}
      ...
      {pageData?.FourStepProcess &&<FourStepProcess processCards={pageData.FourStepProcess.items} theme={pageData.theme} header={pageData.FourStepProcess.title} />}
      {pageData?.ReasonsToBelieve &&<ReasonsToBelieve ingredients={pageData.ReasonsToBelieve.ingredients} content={pageData.ReasonsToBelieve.items} theme={pageData.theme} product={pageData.product} accordanTitle={"CLINICAL STUDIES"}/>}
      ...
      {pageData?.bottomBar &&<>{!isOpen &&<SubscriptionBar content={pageData.bottomBar} ModalHandler={ModalHandler} />}</>}
      </>
    }
    </>
  )
}
RoyalCollagenPeptides.hideLayout = true;
export default RoyalCollagenPeptides;