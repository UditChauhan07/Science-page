...
export default function Spedizione() {
    ...
    return (
        <section className={styles.container}>
            <PageHead content={{title:"Disclaimer | Bruno MD",description:"Health and wellness products rooted in the heart of Italy, made from all-natural ingredients. Pharmaceutical grade supplements to fuel your future."}}/>
            <h1>DISCLAIMER</h1>
