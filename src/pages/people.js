...
const People = ({ version }) => {
  ...
  const pageData = landingData['people'] || {}
  ...
  return (
    ...
    <>
      ...
      {pageData?.ReasonsToBelieve &&<ReasonsToBelieve ingredients={pageData.ReasonsToBelieve.ingredients} accordanTitle={pageData.ReasonsToBelieve.accordanTitle} content={pageData.ReasonsToBelieve.items} theme={pageData.theme} product={pageData.product} />}
